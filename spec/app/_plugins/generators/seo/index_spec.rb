  ...
  describe '.generate' do
    ...
    it 'generates an index with the latest version of each page' do
      expect(subject).to eq({
        ...
        '/hub/kong-inc/jq/overview/' => { 'url' => '/hub/kong-inc/jq/overview/', 'page' => find_page_by_url('/hub/kong-inc/jq/overview/') },
        ...
        '/hub/kong-inc/jwt-signer/overview/' => { 'url' => '/hub/kong-inc/jwt-signer/overview/', 'page' => find_page_by_url('/hub/kong-inc/jwt-signer/overview/') },
        '/hub/kong-inc/jwt-signer/overview/nested/' => { 'url' => '/hub/kong-inc/jwt-signer/overview/nested/', 'page' => find_page_by_url('/hub/kong-inc/jwt-signer/overview/nested/') },
        ...
        '/hub/acme/kong-plugin/overview/' => { 'url' => '/hub/acme/kong-plugin/overview/', 'page' => find_page_by_url('/hub/acme/kong-plugin/overview/') },
        ...
        '/hub/acme/unbundled-plugin/overview/' => { 'url' => '/hub/acme/unbundled-plugin/overview/', 'page' => find_page_by_url('/hub/acme/unbundled-plugin/overview/') },
