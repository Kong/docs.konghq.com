...
### [Fix: Add missing changelog entries for 3.4.3.1 and more](https://github.com/Kong/docs.konghq.com/pull/6697) (2023-12-22)

Added in Enterprise features / fixes for version 3.4.3.1 that was recently discovered missing in the release notes.

Also fixed up a couple of other minor issues / formatting inconsistencies.

Related links:
* https://konghq.atlassian.net/browse/FTI-5570?focusedCommentId=120558
* https://github.com/Kong/kong-ee/blob/next/3.4.x.x/changelog/3.4.3.1/3.4.3.1.md
...
### [(chore) correct port number in readiness check](https://github.com/Kong/docs.konghq.com/pull/6690) (2023-12-20)
...
### [chore: update AppDynamics installation guide](https://github.com/Kong/docs.konghq.com/pull/6687) (2023-12-20)

<!-- What did you change and why? -->
 
Refine the AppDynamics plugin documentation with updated installation instructions, distinguishing between recommended practices for Kong version 3.0.0.0 and later versus alternative approaches for older versions or unique environments.

<!-- Include any supporting resources, e.g. link to a Jira ticket, GH issue, FTI, Slack, Aha, etc. -->
[FTI-5652](https://konghq.atlassian.net/browse/FTI-5652)
...
### [chore(deps): bump kumahq/kuma-website from 21c0852a to a0f63ea9](https://github.com/Kong/docs.konghq.com/pull/6686) (2023-12-20)

Auto upgrade PR log:

a0f63ea9500dc41f7cca5f2716a0dca2dc72ce70 chore(deps): update docs from repo source (kumahq/kuma-website#1557)
43135e74a96abe04c9c69b6cc507bfa180920587 Move app/docs/raw to app/assets (kumahq/kuma-website#1558)
eaf9d9cc1183cf2131d6fd4ddacd1a4908033bed add some info about the GKE autopilot support (kumahq/kuma-website#1555)
079e6db3ebbf7d407c47b61b023a134a159592da Move raw files from `app/docs` to `app/assets/<version>/raw/`  (kumahq/kuma-website#1554)



Automated Kuma update that requires moving the static files from `app/mesh` to `app/assets` so that they are not processed by Jekyll.

#### Modified

- https://docs.konghq.com/mesh/changelog


### [chore(KIC): update references for v2.12.x](https://github.com/Kong/docs.konghq.com/pull/6685) (2023-12-20)

Auto-update the references for KIC v2.12.x
...
### [(chore) 3.5.0.2 Changelog](https://github.com/Kong/docs.konghq.com/pull/6684) (2023-12-21)

source changelog: https://github.com/Kong/kong-ee/pull/7647/files
...
### [(chore) 3.4.3.2 Changelog](https://github.com/Kong/docs.konghq.com/pull/6683) (2023-12-21)

Just starting the PR for now, will add source changelog when it's available.
...
### [docs(mesh): update docs and changelog](https://github.com/Kong/docs.konghq.com/pull/6681) (2023-12-20)

Syncing docs from source code.

Generated by [action](https://github.com/Kong/kong-mesh/actions/runs/7272592500)

#### Added

- https://docs.konghq.com/mesh/2.1.x/raw/crds/access-audit.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/access-role-binding.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/access-role.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_circuitbreakers.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_containerpatches.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_dataplaneinsights.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_dataplanes.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_externalservices.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_faultinjections.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_healthchecks.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshaccesslogs.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshcircuitbreakers.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshes.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshfaultinjections.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshgatewayconfigs.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshgatewayinstances.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshgatewayroutes.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshgateways.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshhealthchecks.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshhttproutes.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshinsights.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshopas.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshproxypatches.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshratelimits.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshretries.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshtimeouts.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshtraces.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_meshtrafficpermissions.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_proxytemplates.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_ratelimits.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_retries.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_serviceinsights.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_timeouts.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_trafficlogs.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_trafficpermissions.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_trafficroutes.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_traffictraces.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_virtualoutbounds.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_zoneegresses.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_zoneegressinsights.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_zoneingresses.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_zoneingressinsights.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_zoneinsights.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/kuma.io_zones.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/crds/opa-policy.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/helm-values.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/kuma-cp.yaml
- https://docs.konghq.com/mesh/2.1.x/raw/protos/OPAPolicy.json
- https://docs.konghq.com/mesh/2.2.x/raw/crds/access-audit.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/access-role-binding.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/access-role.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_circuitbreakers.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_containerpatches.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_dataplaneinsights.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_dataplanes.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_externalservices.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_faultinjections.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_healthchecks.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshaccesslogs.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshcircuitbreakers.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshes.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshfaultinjections.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshgatewayconfigs.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshgatewayinstances.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshgatewayroutes.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshgateways.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshglobalratelimits.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshhealthchecks.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshhttproutes.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshinsights.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshloadbalancingstrategies.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshopas.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshproxypatches.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshratelimits.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshretries.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshtimeouts.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshtraces.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_meshtrafficpermissions.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_proxytemplates.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_ratelimits.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_retries.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_serviceinsights.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_timeouts.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_trafficlogs.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_trafficpermissions.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_trafficroutes.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_traffictraces.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_virtualoutbounds.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_zoneegresses.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_zoneegressinsights.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_zoneingresses.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_zoneingressinsights.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_zoneinsights.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/kuma.io_zones.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/crds/opa-policy.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/helm-values.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/kuma-cp.yaml
- https://docs.konghq.com/mesh/2.2.x/raw/protos/OPAPolicy.json
- https://docs.konghq.com/mesh/2.3.x/raw/crds/access-audit.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/access-role-binding.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/access-role.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_circuitbreakers.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_containerpatches.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_dataplaneinsights.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_dataplanes.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_externalservices.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_faultinjections.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_healthchecks.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshaccesslogs.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshcircuitbreakers.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshes.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshfaultinjections.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshgatewayconfigs.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshgatewayinstances.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshgatewayroutes.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshgateways.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshglobalratelimits.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshhealthchecks.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshhttproutes.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshinsights.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshloadbalancingstrategies.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshopas.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshproxypatches.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshratelimits.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshretries.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshtcproutes.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshtimeouts.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshtraces.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_meshtrafficpermissions.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_proxytemplates.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_ratelimits.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_retries.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_serviceinsights.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_timeouts.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_trafficlogs.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_trafficpermissions.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_trafficroutes.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_traffictraces.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_virtualoutbounds.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_zoneegresses.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_zoneegressinsights.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_zoneingresses.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_zoneingressinsights.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_zoneinsights.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/kuma.io_zones.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/crds/opa-policy.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/helm-values.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/kuma-cp.yaml
- https://docs.konghq.com/mesh/2.3.x/raw/protos/OPAPolicy.json
- https://docs.konghq.com/mesh/2.4.x/raw/crds/access-audit.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/access-role-binding.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/access-role.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_circuitbreakers.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_containerpatches.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_dataplaneinsights.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_dataplanes.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_externalservices.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_faultinjections.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_healthchecks.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshaccesslogs.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshcircuitbreakers.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshes.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshfaultinjections.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshgatewayconfigs.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshgatewayinstances.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshgatewayroutes.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshgateways.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshglobalratelimits.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshhealthchecks.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshhttproutes.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshinsights.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshloadbalancingstrategies.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshopas.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshproxypatches.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshratelimits.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshretries.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshtcproutes.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshtimeouts.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshtraces.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_meshtrafficpermissions.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_proxytemplates.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_ratelimits.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_retries.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_serviceinsights.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_timeouts.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_trafficlogs.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_trafficpermissions.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_trafficroutes.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_traffictraces.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_virtualoutbounds.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_zoneegresses.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_zoneegressinsights.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_zoneingresses.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_zoneingressinsights.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_zoneinsights.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/kuma.io_zones.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/crds/opa-policy.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/helm-values.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/kuma-cp.yaml
- https://docs.konghq.com/mesh/2.4.x/raw/protos/OPAPolicy.json
- https://docs.konghq.com/mesh/2.5.x/raw/crds/access-audit.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/access-role-binding.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/access-role.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_circuitbreakers.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_containerpatches.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_dataplaneinsights.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_dataplanes.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_externalservices.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_faultinjections.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_healthchecks.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshaccesslogs.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshcircuitbreakers.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshes.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshfaultinjections.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshgatewayconfigs.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshgatewayinstances.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshgatewayroutes.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshgateways.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshglobalratelimits.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshhealthchecks.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshhttproutes.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshinsights.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshloadbalancingstrategies.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshopas.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshproxypatches.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshratelimits.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshretries.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshtcproutes.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshtimeouts.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshtraces.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_meshtrafficpermissions.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_proxytemplates.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_ratelimits.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_retries.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_serviceinsights.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_timeouts.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_trafficlogs.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_trafficpermissions.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_trafficroutes.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_traffictraces.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_virtualoutbounds.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_zoneegresses.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_zoneegressinsights.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_zoneingresses.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_zoneingressinsights.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_zoneinsights.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/kuma.io_zones.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/crds/opa-policy.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/helm-values.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/kuma-cp.yaml
- https://docs.konghq.com/mesh/2.5.x/raw/protos/OPAPolicy.json
- https://docs.konghq.com/mesh/dev/raw/crds/access-audit.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/access-role-binding.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/access-role.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_circuitbreakers.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_containerpatches.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_dataplaneinsights.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_dataplanes.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_externalservices.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_faultinjections.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_healthchecks.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshaccesslogs.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshcircuitbreakers.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshes.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshfaultinjections.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshgatewayconfigs.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshgatewayinstances.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshgatewayroutes.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshgateways.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshglobalratelimits.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshhealthchecks.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshhttproutes.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshinsights.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshloadbalancingstrategies.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshmetrics.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshopas.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshproxypatches.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshratelimits.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshretries.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshtcproutes.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshtimeouts.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshtraces.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_meshtrafficpermissions.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_proxytemplates.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_ratelimits.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_retries.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_serviceinsights.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_timeouts.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_trafficlogs.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_trafficpermissions.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_trafficroutes.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_traffictraces.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_virtualoutbounds.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_zoneegresses.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_zoneegressinsights.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_zoneingresses.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_zoneingressinsights.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_zoneinsights.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/kuma.io_zones.yaml
- https://docs.konghq.com/mesh/dev/raw/crds/opa-policy.yaml
- https://docs.konghq.com/mesh/dev/raw/helm-values.yaml
- https://docs.konghq.com/mesh/dev/raw/kuma-cp.yaml
- https://docs.konghq.com/mesh/dev/raw/protos/OPAPolicy.json


### [chore(deps): bump kumahq/kuma-website from 7471ccca to 21c0852a](https://github.com/Kong/docs.konghq.com/pull/6678) (2023-12-19)

Auto upgrade PR log:

21c0852a5bbd1e1081409ece96ded3ac159c0fe7 Remove duplicated line (kumahq/kuma-website#1556)

Triggered by [action](https://github.com/Kong/docs.konghq.com/actions/runs/7255545850).
...
### [(chore) Add Mesh and KIC variables](https://github.com/Kong/docs.konghq.com/pull/6676) (2023-12-18)
...
### [fix(kgo): proper rbac for 1.1.X in KIC Get Started](https://github.com/Kong/docs.konghq.com/pull/6672) (2023-12-18)

Following https://docs.konghq.com/gateway-operator/1.1.x/get-started/kic/install/ leads to a broken setup
...
```log
...
{"level":"error","ts":"2023-12-18T14:56:15Z","msg":"Reconciler error","controller":"gatewayclass","controllerGroup":"gateway.networking.k8s.io","controllerKind":"GatewayClass","GatewayClass":{"name":"kong"},"namespace":"","name":"kong","reconcileID":"3597a449-5190-4fec-8f71-a52bcca235fc","error":"failed updating GatewayClass: gatewayclasses.gateway.networking.k8s.io \"kong\" is forbidden: User \"system:serviceaccount:kong-system:gateway-operator-controller-manager\" cannot update resource \"gatewayclasses/status\" in API group \"gateway.networking.k8s.io\" at the cluster scope","stacktrace":"sigs.k8s.io/controller-runtime/pkg/internal/controller.(*Controller).reconcileHandler\n\t/home/runner/go/pkg/mod/sigs.k8s.io/controller-runtime@v0.16.3/pkg/internal/controller/controller.go:329\nsigs.k8s.io/controller-runtime/pkg/internal/controller.(*Controller).processNextWorkItem\n\t/home/runner/go/pkg/mod/sigs.k8s.io/controller-runtime@v0.16.3/pkg/internal/controller/controller.go:266\nsigs.k8s.io/controller-runtime/pkg/internal/controller.(*Controller).Start.func2.2\n\t/home/runner/go/pkg/mod/sigs.k8s.io/controller-runtime@v0.16.3/pkg/internal/controller/controller.go:227"}
{"level":"error","ts":"2023-12-18T14:56:15Z","msg":"Reconciler error","controller":"gatewayclass","controllerGroup":"gateway.networking.k8s.io","controllerKind":"GatewayClass","GatewayClass":{"name":"kong"},"namespace":"","name":"kong","reconcileID":"74659a88-8637-4aec-b2b6-b23020418e42","error":"failed updating GatewayClass: gatewayclasses.gateway.networking.k8s.io \"kong\" is forbidden: User \"system:serviceaccount:kong-system:gateway-operator-controller-manager\" cannot update resource \"gatewayclasses/status\" in API group \"gateway.networking.k8s.io\" at the cluster scope","stacktrace":"sigs.k8s.io/controller-runtime/pkg/internal/controller.(*Controller).reconcileHandler\n\t/home/runner/go/pkg/mod/sigs.k8s.io/controller-runtime@v0.16.3/pkg/internal/controller/controller.go:329\nsigs.k8s.io/controller-runtime/pkg/internal/controller.(*Controller).processNextWorkItem\n\t/home/runner/go/pkg/mod/sigs.k8s.io/controller-runtime@v0.16.3/pkg/internal/controller/controller.go:266\nsigs.k8s.io/controller-runtime/pkg/internal/controller.(*Controller).Start.func2.2\n\t/home/runner/go/pkg/mod/sigs.k8s.io/controller-runtime@v0.16.3/pkg/internal/controller/controller.go:227"}
...
```

Due to a problem with the configuration applied with 

```
kubectl apply -f https://docs.konghq.com/assets/gateway-operator/v1.1.0/all_controllers.yaml
```

This PR updates file `assets/gateway-operator/v1.1.0/all_controllers.yaml` by generating it from the PR

- https://github.com/Kong/gateway-operator/pull/1255

that includes the required fix. 
...
### [docs(mesh): update docs and changelog](https://github.com/Kong/docs.konghq.com/pull/6671) (2023-12-18)

Syncing docs from source code.

Generated by [action](https://github.com/Kong/kong-mesh/actions/runs/7251296499)
...
### [fix: add missing `X-Kong-Request-Debug-Token` header of request-debug docs](https://github.com/Kong/docs.konghq.com/pull/6665) (2023-12-19)
...
### [feat: Konnect custom DCR docs](https://github.com/Kong/docs.konghq.com/pull/6662) (2023-12-19)

<!-- What did you change and why? -->
Konnect will now allow customers to create a custom implementation for DCR so they can use an IdP of their choice. We need to point them to the example implementation so they know how to configure it, explain how the configuration works, and also show them the API specs they can use for automation.
...
- https://docs.konghq.com/konnect/dev-portal/applications/dynamic-client-registration/custom
