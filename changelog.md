...
### [noname description update](https://github.com/Kong/docs.konghq.com/pull/6375) (2023-10-26)
...
### [chore(deps): bump kumahq/kuma-website from 8a35288f to b95c7b8b](https://github.com/Kong/docs.konghq.com/pull/6360) (2023-10-27)

Auto upgrade PR log:

b95c7b8bd81a13279a6424f65489d90009e57338 docs(certs): Add note about supported cert types to docs (kumahq/kuma-website#1484)
347a1ceb8cabda484d67a716e627d247ba2156c7 chore(deps): update docs from repo source (kumahq/kuma-website#1497)
93ce915b31dc39ff5fc1040f5ed2e3839ab1053c fix: typos in doc (proxies and slashes) (kumahq/kuma-website#1495)

Triggered by [action](https://github.com/Kong/docs.konghq.com/actions/runs/6661206095).
...
### [doc(kic) add GWAPI redirect instructions](https://github.com/Kong/docs.konghq.com/pull/6335) (2023-10-27)
...
Fix https://github.com/Kong/kong-mesh/issues/3503
Preview https://deploy-preview-6320--kongdocs.netlify.app/konnect/mesh-manager/migrate-zone/
<!-- Include any supporting resources, e.g. link to a Jira ticket, GH issue, FTI, Slack, Aha, etc. -->
...
### [chore(deps): bump kumahq/kuma-website from 4250ff55 to 8a35288f](https://github.com/Kong/docs.konghq.com/pull/6312) (2023-10-24)

Auto upgrade PR log:

8a35288f80660495473fb56594f57086a5e28bff chore(deps): update docs from repo source (kumahq/kuma-website#1489)
b2ae1725513010fd34ad8356275ff3af013004e5 chore(deps): update docs from repo source (kumahq/kuma-website#1488)
8b9562ef470f46f10fc5d29a21a713658c718c3a docs(production): init containers (kumahq/kuma-website#1423)
21af6cdfa55b54cd6baa1968dbfe0df637189f15 chore(deps): update docs from repo source (kumahq/kuma-website#1487)
ad553c3c923913eec75a1bc00cb4fa3e80c5f563 fix(gateway): make xmesh gateway multizone limitation version specific (kumahq/kuma-website#1486)
59d4c2b80e2898cee1137d305254b276ee3ac0ba feat: add kubernetes docs with diverse info (kumahq/kuma-website#1482)
7e7c2080a1fb8d2f359ccce5429b5e9fd0a61a0a feat(policies): add support for MeshGateway in MeshProxyPatch (kumahq/kuma-website#1485)

Triggered by [action](https://github.com/Kong/docs.konghq.com/actions/runs/6620564105).
