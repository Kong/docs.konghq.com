---
title: Configure Multi-Zone Authentication
---
...
On the global control plane, [authenticate](/mesh/{{page.kong_versions}}/features/zero-trust/certificates/#user-to-control-plane-communication) and run the following command:
...
By default, a connection from the zone control plane to the global control plane is secured with TLS. You should also configure the zone control plane to [verify the certificate authority (CA) of the global control plane](/mesh/{{page.kong_versions}}/features/zero-trust/certificates/#control-plane-to-control-plane-multizone).
