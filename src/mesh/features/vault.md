---
title: Configure a Vault Policy
---
...
* [`certmanager`](/mesh/{{page.kong_version}}/features/zero-trust/cert-manager): {{site.mesh_product_name}} generates data plane certificates
...
[mesh-scoped secret](/mesh/{{page.kong_version}}/production/security/manage-secrets/). On Kubernetes, this mesh-scoped secret should be stored
