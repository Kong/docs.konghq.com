...
{% include_cached md/kubernetes-ingress-controller/kong_cluster_plugin_description.md kong_version=page.kong_version %}
...
{% include_cached md/kubernetes-ingress-controller/kong_consumer_description.md kong_version=page.kong_version %}
...
{% include_cached md/kubernetes-ingress-controller/kong_ingress_description.md kong_version=page.kong_version %}
...
{% include_cached md/kubernetes-ingress-controller/kong_plugin_description.md kong_version=page.kong_version %}
...
{% include_cached md/kubernetes-ingress-controller/ingress_class_parameters_description.md kong_version=page.kong_version %}
...
{% include_cached md/kubernetes-ingress-controller/tcp_ingress_description.md kong_version=page.kong_version %}
...
{% include_cached md/kubernetes-ingress-controller/udp_ingress_description.md kong_version=page.kong_version %}
