...
* You have [configured your Service](/gateway/{{page.kong_version}}/get-started/services-and-routes) in {{site.base_gateway}}

## 1. Configure the key-auth plugin

To configure the key-auth plugin for the Service you <a href="/gateway/{{page.kong_version}}/get-started/services-and-routes/">configured in Kong</a>,
...
[plugins]: /hub/
[adding-consumers]: /gateway/{{page.kong_version}}/get-started/adding-consumers
