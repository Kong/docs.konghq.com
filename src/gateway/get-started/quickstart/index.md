...
One quick way to get {{site.base_gateway}} up and running is by using [Docker with a PostgreSQL database](/gateway/{{page.kong_version}}/install/docker). We recommend this method to test out basic {{site.base_gateway}} functionality.
