...
[Vitals with InfluxDB](/gateway/{{page.kong_version}}/analytics/vitals-influx-strategy/).  
...
4. A Vitals report generates, starting with a summary of data in your report, including Id, Name, App Name, App Id, and Total. Note that the App Name and App Id are dependent on the Dev Portal App Registration plugin. For more information about status codes (2XX, 4XX, etc), see [_Vitals Metrics_](/gateway/{{page.kong_version}}/analytics/vitals-metrics/).
