...
Custom JavaScript can also be added to run only on specific layouts, allowing you to maintain server-side rendering. [Learn more](/gateway/{{page.kong_version}}/kong-enterprise/dev-portal/theme-customization/adding-javascript-assets) about adding JavaScript to a layout without implementing an SPA.
