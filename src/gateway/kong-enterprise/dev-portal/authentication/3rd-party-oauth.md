...
[Authorization Provider Strategy](/gateway/{{page.kong_version}}/dev-portal/administration/application-registration/auth-provider-strategy).
...
[custom claim](/gateway/{{page.kong_version}}/dev-portal/administration/application-registration/okta-config#auth-server-cclaim)
...
* [Okta](https://developer.okta.com/). See the
  [Okta setup example](/gateway/{{page.kong_version}}/dev-portal/administration/application-registration/okta-config).
* [Azure](https://azure.microsoft.com/). See the
  [Azure setup example](/gateway/{{page.kong_version}}/dev-portal/administration/application-registration/azure-oidc-config).
...
[`show_issuer`](/gateway/{{page.kong_version}}/dev-portal/administration/application-registration/enable-application-registration#app-reg-params) is enabled in the
