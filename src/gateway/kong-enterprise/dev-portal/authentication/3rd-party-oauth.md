...
[Authorization Provider Strategy](/gateway/{{page.kong_version}}/kong-enterprise/dev-portal/authentication/application-registration/auth-provider-strategy).
...
[custom claim](/gateway/{{page.kong_version}}/kong-enterprise/dev-portal/authentication/application-registration/okta-config#auth-server-cclaim)
...
* [Okta](https://developer.okta.com/). See the
  [Okta setup example](/gateway/{{page.kong_version}}/kong-enterprise/dev-portal/authentication/application-registration/okta-config).
* [Azure](https://azure.microsoft.com/). See the
  [Azure setup example](/gateway/{{page.kong_version}}/kong-enterprise/dev-portal/authentication/application-registration/azure-oidc-config).
...
[`show_issuer`](/gateway/{{page.kong_version}}/kong-enterprise/dev-portal/authentication/application-registration/enable-application-registration#app-reg-params) is enabled in the
