...
[Sessions in the Dev Portal](/gateway/{{page.kong_version}}/dev-portal/configuration/authentication/sessions).
...
[Developer Roles and Content Permissions](/gateway/{{page.kong_version}}/dev-portal/administration/developer-permissions).
...
[Sessions](/gateway/{{page.kong_version}}/dev-portal/configuration/authentication/sessions#portal-session-conf).

- For more information about domains and cookies in Dev Portal sessions, see
[Domains](/gateway/{{page.kong_version}}/dev-portal/configuration/authentication/sessions#domains).
