...
* Create a Service.
* Enable the [Application Registration plugin](/gateway/{{page.kong_version}}/kong-enterprise/dev-portal/authentication/application-registration/enable-application-registration) on a Service.
