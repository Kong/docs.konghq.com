...
1. Enable the [Application Registration plugin](/gateway/{{page.kong_version}}/kong-enterprise/dev-portal/authentication/application-registration/enable-application-registration) on a Service.
...
2. Enable a supported authentication plugin on the same Service as the Application Registration plugin,
    ...
    * If using the `kong-oauth2` authorization strategy with key authentication, configure the
    ...
    [recommended workflows](/gateway/{{page.kong_version}}/kong-enterprise/dev-portal/authentication/application-registration/3rd-party-oauth#supported-oauth-flows).
    ...
    [Okta](/gateway/{{page.kong_version}}/kong-enterprise/dev-portal/authentication/application-registration/okta-config)
    or the [Azure](/gateway/{{page.kong_version}}/kong-enterprise/dev-portal/authentication/application-registration/azure-oidc-config) setup examples.
