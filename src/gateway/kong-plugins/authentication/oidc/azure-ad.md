...
[Set Up External Portal Application Authentication with Azure AD and OIDC](/gateway/{{page.kong_version}}/kong-enterprise/dev-portal/authentication/application-registration/azure-oidc-config).
