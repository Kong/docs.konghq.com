...
- *`debug`:* It provides debug information about the plugin's run loop and each individual plugin or other components. Only to be used during debugging since it is too chatty.
