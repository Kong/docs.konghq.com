...
service_body: |
    ...
    `protocol` |  The protocol used to communicate with the upstream.  Accepted values are: `"grpc"`, `"grpcs"`, `"http"`, `"https"`, `"tcp"`, `"tls"`, `"tls_passthrough"`, `"udp"`, `"ws"` {:.badge .enterprise}, `"wss"` {:.badge .enterprise}.  Default: `"http"`.
...
* For `ws`, at least one of `hosts`, `headers` or `paths`; {:.badge .enterprise}
* For `wss`, at least one of `hosts`, `headers`, `paths` or `snis`; {:.badge .enterprise}
