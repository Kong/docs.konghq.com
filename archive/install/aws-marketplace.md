...
1. **Cassandra**
    ...
    The Kong AWS Marketplace AMI image is designed for simplicity and fast deployment, this means it comes bundled with [Cassandra](https://konghq.com/faqs/) on the same image.
