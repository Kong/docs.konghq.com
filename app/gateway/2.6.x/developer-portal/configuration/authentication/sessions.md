...
* If using different subdomains for the [`portal_api_url`](/gateway/{{page.release}}/reference/configuration/#portal_api_url) and [`portal_gui_host`](/gateway/{{page.release}}/reference/configuration/#portal_gui_host), see the example below for [Domains](/gateway/{{page.release}}/developer-portal/configuration/authentication/sessions/#domains).
