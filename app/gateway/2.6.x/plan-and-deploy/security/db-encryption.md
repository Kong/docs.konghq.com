...
{{site.base_gateway}} provides a mechanism to store sensitive data fields, such as consumer secrets, in an encrypted format within the database (PostgreSQL or Cassandra). This provides for encryption-at-rest security controls in a Kong cluster.
