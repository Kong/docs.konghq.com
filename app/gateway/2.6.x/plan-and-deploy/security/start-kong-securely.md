...
After [installing {{site.base_gateway}}](/gateway/{{page.release}}/install-and-run/),
...
[Securing Kong Manager](/gateway/{{page.release}}/configure/auth/kong-manager/) for other types
of authentication.
...
follow [this guide](/gateway/{{page.release}}/configure/auth/rbac/add-admin/) to remediate.
...
[invite a new user as a Super Admin in Kong Manager](/gateway/{{page.release}}/configure/auth/kong-manager/super-admin/).
