...
![Features in getting started guide](/assets/images/gateway/getting-started-guide/Kong-GS-overview.png)
...
![API Gateway traffic](/assets/images/gateway/getting-started-guide/gateway-traffic.png)
