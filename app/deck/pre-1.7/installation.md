...
```shell
$ curl -sL https://github.com/kong/deck/releases/download/v{{page.releases_hash[0].version}}/deck_{{page.releases_hash[0].version}}_linux_amd64.tar.gz -o deck.tar.gz
