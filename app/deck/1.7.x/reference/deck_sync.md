...
Sync command reads the state file and performs operation on Kong
...
```
      --db-update-propagation-delay int   aritificial delay in seconds that is injected between insert operations
