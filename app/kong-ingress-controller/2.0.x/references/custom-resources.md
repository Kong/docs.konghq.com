...
Please see the [concept](/kong-ingress-controller/{{page.kong_version}}/concepts/custom-resources/#KongPlugin)
...
Please read the [concept](/kong-ingress-controller/{{page.kong_version}}/concepts/custom-resources/#kongingress)
...
For help configuring credentials for the `KongConsumer` Please refer to the [using the Kong Consumer and Credential resource](/kong-ingress-controller/{{page.kong_version}}/guides/using-consumer-credential-resource/) guide.
