...
There are two options to install {{site.ee_product_name}} on Amazon Linux 2.

{% navtabs %}
{% navtab Download RPM File %}

1. Go to: [{{ site.links.download }}/kong/kong-enterprise-edition-aws]({{ site.links.download }}/kong/kong-enterprise-edition-aws).
2. Select the `aws` folder. {{site.ee_product_name}} versions are listed in reverse chronological order.
