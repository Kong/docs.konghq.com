...
for {{site.ee_product_name}} and sync API designs directly to the Kong Developer Portal.
...
<div class="docs-grid">
  ...
  <div class="docs-grid-block">
    ...
    <a href="/enterprise/{{page.kong_version}}/studio/deploy-to-dev-portal">
        Connect to {{site.ee_product_name}} and deploy specs to the Kong Developer Portal &rarr;
    </a>
  </div>
