...
The following documentation refers to {{site.ee_product_name}}-specific Admin API functionality. For a complete reference, check out the <a href="/gateway-oss/latest/admin-api">Kong Admin API Reference</a>.
</div>
