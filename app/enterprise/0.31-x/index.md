---
title: Kong Enterprise (EE) Documentation
---
...
<div class="alert alert-ee">
  <div class="alert-body">
    ...
    <p>Kong Enterprise (EE) adds features, functionality, and performance to Kong (CE). This documentation doesn’t cover the general practices of using Kong that are common to both Kong and EE - learn the <a href="">basics in Kong documentation</a>.</p>
  </div>
</div>
{% endif %}
