...
Log levels are set in [Kong's configuration](/enterprise/{{page.kong_version}}/configuration/#log_level). Following are the log levels in increasing order of their severity, `debug`, `info`,
