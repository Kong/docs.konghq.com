...
10. Copy the rpm file to your home directory on the RHEL system. You may use a command like:
...
You now should have two files in your home directory on the target RHEL system:
