...
### Enable Kong Manager
  ...
  Kong Enterprise's Graphical User Interface **Kong Manager** can be connected by setting the `admin_gui_url` property to the EC2 instances `IPv4` address and the admin_listen property to allow **Kong Manager** to communicate to the Admin API.
