...
>Note: Installation steps in this topic include installing Kong for Kubernetes using YAML. Other deployment options, such as using Helm Chart and Kustomize, will be available at a later time. 
