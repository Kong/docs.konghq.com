...
* The [Upstream TLS](/hub/kong-inc/upstream-tls/) plugin was deprecated in version 1.3, and removed in version 1.5. If you have configured this plugin, remove the plugin before upgrading to version 1.5. Otherwise, {{site.ee_product_name}} will fail to start due to the missing plugin.
