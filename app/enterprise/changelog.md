...
* The LDAP Authentication and LDAP Authentication Advanced plugins require a workaround to support CLI access with RBAC tokens: [Using Service Directory Mapping on the CLI](enterprise/2.1.x/kong-manager/authentication/ldap/#using-service-directory-mapping-on-the-cli-1).
