...
5. Save the available RPM file. For example: `kong-enterprise-edition-{{page.kong_versions[8].version}}.el7.noarch.rpm`
...
2. Securely copy the changed repo file to your home directory on the CentOS system:
