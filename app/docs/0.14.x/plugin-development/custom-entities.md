...
Once that module returns your entity's schema, and assuming your plugin is loaded by Kong (see the `plugins` property in `kong.yml`), the DAO Factory will use it to instanciate a DAO object.
