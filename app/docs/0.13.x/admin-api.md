...
<div class="alert alert-warning">
  ...
  <p><strong>Note: The API object was deprecated in Kong 0.13.0</strong></p>
  <p>It is strongly recommended to migrate them Routes and Services as soon as possible.</p>
  </div>
</div>
