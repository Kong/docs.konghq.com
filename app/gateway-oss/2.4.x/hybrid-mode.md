...
Data Plane certificates issued must contain the Certificate Authority Information Access extension
that contains the URI of OCSP responder that may be reached from the Control Plane.
