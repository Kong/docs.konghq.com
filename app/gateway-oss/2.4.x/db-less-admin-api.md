...
upstream_body: |
    ...
    `slots`<br>*optional* | The maximum number of slots in the `round-robin` load balancer algorithm or the actual number of slots in the `consistent-hashing` algorithm (`10`-`65536`). Default: `10000`.
