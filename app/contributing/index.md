...
If you've written a Kong plugin and need to contribute documentation for it, see the docs [about plugin docs](/contributing/plugin-docs).
...
* Our [style guide](/contributing/style-guide). Provides a minimal set of style guidelines we ask you to adhere to.
