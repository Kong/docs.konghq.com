...
Using the [advanced load-balancer](/gateway/latest/how-kong-works/load-balancing/#advanced-load-balancing), target weights can be adjusted granularly, allowing
