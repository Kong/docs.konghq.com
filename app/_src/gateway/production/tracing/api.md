...
* [FaaS](https://opentelemetry.io/docs/specs/semconv/faas/faas-spans/): For [Function as a Service](https://en.wikipedia.org/wiki/Function_as_a_service) (e.g., AWS Lambda) spans.
