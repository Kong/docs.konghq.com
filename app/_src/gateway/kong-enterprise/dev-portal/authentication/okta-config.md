...
[Application Registration](/gateway/{{page.release}}/kong-enterprise/dev-portal/applications/enable-application-registration#config-app-reg-plugin).
...
your Okta application will vary:
    ...
    You will need your `client_id` and `client_secret` later on when you [authenticate with the proxy](/gateway/{{page.release}}/kong-enterprise/dev-portal/authentication/3rd-party-oauth#cc-flow).
...
[third-party OAuth flows](/gateway/{{page.release}}/kong-enterprise/dev-portal/authentication/3rd-party-oauth).
