...
Custom JavaScript can also be added to run only on specific layouts, allowing you to maintain server-side rendering. [Learn more](/gateway/{{page.release}}/kong-enterprise/dev-portal/customize/adding-javascript-assets/) about adding JavaScript to a layout without implementing an SPA.
