...
**Important**: The Vitals Reports feature is not compatible with any other database. If not using InfluxDB,  the Reports button will not display on the Vitals view.
