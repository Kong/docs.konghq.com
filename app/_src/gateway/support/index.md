...
The following matrix describes the distributions available for each supported version of Kong Gateway. End of support for these distributions is tied to end of support for the Kong Gateway version, unless the distribution manufacturer's end of life date is sooner. 
