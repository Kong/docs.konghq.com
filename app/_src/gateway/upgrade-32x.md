---
title: Upgrade Kong Gateway 3.2.x
content_type: how-to
---
...
| 3.0.x | Traditional | Yes | [Upgrade to 3.2.x](#upgrade-from-30x-to-31x). |
| 3.0.x | Hybrid | Yes | [Upgrade to 3.2.x](#upgrade-from-30x-to-31x). |
| 3.0.x | DB less | Yes | [Upgrade to 3.2.x](#upgrade-from-30x-to-31x). |
| 3.1.x | Traditional | No | [Upgrade to 3.1.2.0](/gateway/3.0.x/upgrade/), and then [upgrade to 3.2.x](#upgrade-from-30x-to-31x). |
| 3.1.x | Hybrid | No | [Upgrade to 3.1.2.0](/gateway/3.0.x/upgrade/), and then [upgrade to 3.2.x](#upgrade-from-30x-to-31x). |
| 3.1.x | DB less | No | [Upgrade to 3.1.2.0](/gateway/3.0.x/upgrade/), and then [upgrade to 3.2.x](#upgrade-from-30x-to-31x). |
