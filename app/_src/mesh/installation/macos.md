...
You can also download the [amd64]({{site.links.direct}}/kong-mesh-legacy/raw/names/kong-mesh-darwin-amd64/versions/{{page.version}}/kong-mesh-{{page.version}}-darwin-amd64.tar.gz) or [arm64]({{site.links.direct}}/kong-mesh-legacy/raw/names/kong-mesh-darwin-arm64/versions/{{page.version}}/kong-mesh-{{page.version}}-darwin-arm64.tar.gz) distribution manually.
