...
{% include_cached /md/kic/prerequisites.md release=page.release disable_gateway_api=false enterprise=true %}

{% include /md/kic/test-service-echo.md release=page.release %}

{% include_cached /md/kic/http-test-routing.md release=page.release path='/echo' name='echo' hostname="127.0.0.1.nip.io" no_indent=true %}
