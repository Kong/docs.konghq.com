...
- [Gateway and GatewayClass](/kong-ingress-controller/{{page.kong_version}}/references/gateway-api-support/#gateways-and-gatewayclasses)
- [HTTPRoute](/kong-ingress-controller/{{page.kong_version}}/references/gateway-api-support/#httproutes)
- [TCPRoute](/kong-ingress-controller/{{page.kong_version}}/references/gateway-api-support/#tcproutes)
- [UDPRoute](/kong-ingress-controller/{{page.kong_version}}/references/gateway-api-support/#udproutes)
- [TLSRoute](/kong-ingress-controller/{{page.kong_version}}/references/gateway-api-support/#tlsroutes)
{% endif_version %}
{% if_version gte:2.4.x lte:2.6.x %}
- [`ReferencePolicy`](/kong-ingress-controller/{{page.kong_version}}/references/gateway-api-support/#referencepolicies)
{% endif_version %}
{% if_version gte:2.6.x %}
- [ReferenceGrant](/kong-ingress-controller/{{page.kong_version}}/references/gateway-api-support/#referencegrants)
{% endif_version %}
...
```bash
kubectl apply -f {{site.links.web}}/assets/kong-ingress-controller/examples/echo-service.yaml
```
