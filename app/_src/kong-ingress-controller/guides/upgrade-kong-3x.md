...
{:.important}
> **Important**: `Prefix` and `Exact` rules [must never use regular expressions](/kong-ingress-controller/{{page.kong_version}}/concepts/ingress-versions/#networkingk8siov1).
