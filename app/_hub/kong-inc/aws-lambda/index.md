  ...
  config:
    ...
    - name: skip_large_bodies
      ...
      description: |
        ...
        bodies that are buffered to disk. Note that enabling this
        ...
        nginx workers. That may be tens of thousands of other
        transactions which are not being processed. For small I/O
        ...
        cause notable interruptions in request processing. Given all of the downsides of enabling this option, please consider increasing the [client_body_buffer_size](http://nginx.org/en/docs/http/ngx_http_core_module.html#client_body_buffer_size)
        value instead.
