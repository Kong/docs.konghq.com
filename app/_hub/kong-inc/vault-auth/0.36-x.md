...
params:
  ...
  config:
    ...
    - name: vault
      ...
      default:
      description: |
        A reference to an existing `vault` object within the database. `vault` entities define the connection and authentication parameters used to connection to a Vault HTTP(S) API.
...
[consumer-object]: https://docs.konghq.com/enterprise/0.36-x/admin-api/#consumer-object
