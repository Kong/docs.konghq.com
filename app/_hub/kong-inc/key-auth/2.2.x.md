  ...
  config:
    ...
    - name: hide_credentials
      ...
      description: |
        ...
        the plugin strips the credential from the request (i.e., the header or query string containing the key) before proxying it.
    - name: anonymous
      required: false
      default:
      description: |
...
Simply make a request with the key as a query string parameter:
...
Delete an API Key by making the following HTTP request:
