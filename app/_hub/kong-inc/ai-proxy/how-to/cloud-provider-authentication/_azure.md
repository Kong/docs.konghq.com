...
and running them through AI Proxy, you can use the assigned
...
## Configure the AI Proxy plugin to use Azure Identity

When running {{site.base_gateway}} inside of your Azure subscription, AI Proxy is usually able to detect the designated Managed Identity or User-Assigned Identity
