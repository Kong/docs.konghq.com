...
[**Upstream Healthchecks**](/gateway-oss/{{page.kong_version}}/admin-api/#upstream-objects)
...
target. For this configuration to take effect, the following conditions must be met:
 ...
 object
 - [**Healthchecks**](/gateway-oss/{{page.kong_version}}/health-checks-circuit-breakers/) are
