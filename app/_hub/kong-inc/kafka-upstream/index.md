...
params:
  ...
  config:
    ...
    - name: cluster_name
      ...
      datatype: string
      description: |
        A unique Kafka cluster identifier. By default, this field generates a
        unique ID. You can also provide your own your own unique cluster
        identifier.

        If more than one Kafka plugin is configured without a `cluster_name`,
        these plugins will use the same cluster. Logs will be sent to the
