...
1. Create a confidential client `kong` with `private_key_jwt` authentication and configure
   ...
   <br><br>
   <img src="/assets/images/plugins/openid-connect/keycloak-client-kong-settings.png">
   <br>
   <img src="/assets/images/plugins/openid-connect/keycloak-client-kong-auth.png">
   <br>
2. Create another confidential client `service` with `client_secret_basic` authentication.
   ...
   <br><br>
   <img src="/assets/images/plugins/openid-connect/keycloak-client-service-settings.png">
   <br>
   <img src="/assets/images/plugins/openid-connect/keycloak-client-service-auth.png">
   <br>
3. Create a verified user with the name: `john` and the non-temporary password: `doe` that can be used with the password grant:
   <br><br>
   <img src="/assets/images/plugins/openid-connect/keycloak-user-john.png">

Alternatively you can [download the exported Keycloak configuration](/assets/images/plugins/openid-connect/keycloak.json),
...
![Authorization code flow diagram](/assets/images/plugins/openid-connect/authorization-code-flow.svg)
...
1. Open the Service Page with some query arguments:
   ...
   ```
   <img src="/assets/images/plugins/openid-connect/authorization-code-flow-1.png">

2. See that the browser is redirected to the Keycloak login page:
   <br><br>
   <img src="/assets/images/plugins/openid-connect/authorization-code-flow-2.png">
   <br>
...
3. And finally you will be presented a response from httpbin.org:
   <br><br>
   <img src="/assets/images/plugins/openid-connect/authorization-code-flow-3.png">
4. Done.
...
<img src="/assets/images/plugins/openid-connect/password-grant.svg">
...
<img src="/assets/images/plugins/openid-connect/client-credentials-grant.svg">
...
<img src="/assets/images/plugins/openid-connect/refresh-token-grant.svg">
...
<img src="/assets/images/plugins/openid-connect/bearer-authentication.svg">
...
<img src="/assets/images/plugins/openid-connect/introspection-authentication.svg">
...
<img src="/assets/images/plugins/openid-connect/userinfo-authentication.svg">
...
<img src="/assets/images/plugins/openid-connect/kong-oauth-authentication.svg">
...
<img src="/assets/images/plugins/openid-connect/session-authentication.svg">
