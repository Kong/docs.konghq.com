...
{:.note}
> If you are using Kong Ingress Controller(https://github.com/Kong/kubernetes-ingress-controller), the installation is slightly different. Review the [docs for Kubernetes Ingress](/kong-ingress-controller/latest/guides/setting-up-custom-plugins/).
