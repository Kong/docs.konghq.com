...
| --controller-ingress-extensionsv1beta1 | `boolean`  | Enable or disable the Ingress controller (using API version extensions/v1beta1)                                                                     | `true`                            |
| --controller-ingress-networkingv1      | `boolean`  | Enable or disable the Ingress controller (using API version networking.k8s.io/v1)                                                                   | `true`                            |
| --controller-ingress-networkingv1beta1 | `boolean`  | Enable or disable the Ingress controller (using API version networking.k8s.io/v1beta1)                                                              | `true`                            |
| --controller-knativeingress            | `boolean`  | Enable or disable the KnativeIngress controller                                                                                                     | `true`                            |
| --controller-kongclusterplugin         | `boolean`  | Enable or disable the KongClusterPlugin controller                                                                                                  | `true`                            |
| --controller-kongconsumer              | `boolean`  | Enable or disable the KongConsumer controller                                                                                                       | `true`                            |
| --controller-kongingress               | `boolean`  | Enable or disable the KongIngress controller                                                                                                        | `true`                            |
| --controller-kongplugin                | `boolean`  | Enable or disable the KongPlugin controller                                                                                                         | `true`                            |
| --controller-kongstate                 | `boolean`  | Enable or disable the KongState controller                                                                                                          | `true`                            |
| --controller-service                   | `boolean`  | Enable or disable the Service controller                                                                                                            | `true`                            |
| --controller-tcpingress                | `boolean`  | Enable or disable the TCPIngress controller                                                                                                         | `true`                            |
| --controller-udpingress                | `boolean`  | Enable or disable the UDPIngress controller                                                                                                         | `true`                            |
