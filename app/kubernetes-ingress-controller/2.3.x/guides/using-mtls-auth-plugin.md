...
You should use your own CA certificate, or generate a self-signed certificate for testing.** Here is a guide on how to generate self-signed CA certificate using openssl.
