...
* Control which geographic region the universal API control plane is operated in. US and EU regions are currently supported. This allows you to operate {{site.konnect_short_name}} in a similar geographic region to your end-users, as well as ensure data privacy and regulatory compliance. 
