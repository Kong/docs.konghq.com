...
If your organization has multiple [geographic regions](/konnect/regions/)<span class="badge beta"></span>, developers must register and request access to the Dev Portal in each region separately. Dev Portals in different regions don't share any data, including developer information.
