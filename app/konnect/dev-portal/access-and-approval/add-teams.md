...
In the {{site.konnect_short_name}} Dev Portal, you can now manage your teams in one place by mapping existing developer teams from a third-party identity provider (IdP) automatically (instead of manually copying over every single team of developers from your IdP to {{site.konnect_short_name}}). This functionality also allows you to map over any apassociated permissions to elements in {{site.konnect_short_name}}, providing a unified Team management experience between your IdP and Konnect.
