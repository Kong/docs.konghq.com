...
Once developers start registering for your Dev Portal, you can manually approve their application. All pending developer requests are displayed in the Developers tab of the **Requests** section.

* In the row for developer request you want to approve, click the {% konnect_icon cogwheel %} and choose
...
*  In the row for developer request you want to reject, click the{% konnect_icon cogwheel %} and choose
...
* In the row for developer request you want to delete, click the {% konnect_icon cogwheel %} and choose
...
* In the row for the developer whose status you want to change, click the {% konnect_icon cogwheel %} and choose **Revoke** from the
   context menu.
...
* In the row for the developer whose status you want to change, click the icon and choose **Approve** from the
   context menu.
...
* In the row for the developer you want to delete, click the icon and choose **Delete** from the
   context menu.
