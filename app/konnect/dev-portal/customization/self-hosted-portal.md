...
* **Range of customization options:** With the self-hosted Dev Portal, you determine how much you want to customize. You can choose to use the [example application](https://github.com/Kong/konnect-portal) right out of the box or you can use the Portal API to have more fine-grained control.
...
To enable the self-hosted Dev Portal in {{site.konnect_short_name}}, click {% konnect_icon dev-portal %} **Dev Portal** > [**Settings**](https://cloud.konghq.com/portal/portal-settings) in the sidebar and then click the **Portal Domain** tab. Once you specify a custom portal domain API in the **Custom Hosted Domain** field and a custom portal client domain in the **Custom Self-Hosted UI Domain** field, your self-hosted portal is enabled. After enabling the portal, you must configure the settings in your static site generator to deploy your Dev Portal.
