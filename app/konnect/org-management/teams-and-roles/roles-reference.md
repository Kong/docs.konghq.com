...
See [Manage Teams and Roles](/konnect/org-management/teams-and-roles). All predefined roles and teams automatically get access to all geographic regions in your {{site.konnect_short_name}} instance.
