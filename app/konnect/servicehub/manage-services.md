...
6. Click **Archive Version** to archive the Service version, thereby preventing that version from showing up on the UI. Users will not be able to send requests to the Service version endpoints and those endpoints will no longer be supported.
