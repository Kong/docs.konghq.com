...
{:.note}
> **Note**: You can only publish services in your [geographic region](/konnect/regions)<span class="badge beta"></span> to the Dev Portal in your region. If you want to publish services to a Dev Portal in another region, switch to the new region in the top-right of {{site.konnect_product_name}}.
