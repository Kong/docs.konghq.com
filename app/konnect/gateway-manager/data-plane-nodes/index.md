...
![Konnect install options](/assets/images/konnect/gateway-manager/konnect-install-options.png){:.image-border}
...
### Data plane node dashboard
![gateway data plane node dashboard](/assets/images/konnect/gateway-manager/konnect-runtime-instance-gateway.png)
