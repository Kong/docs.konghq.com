...
![List of plugins in a control plane](/assets/images/konnect/gateway-manager/plugins/konnect-plugin-list.png)
...
![Custom plugins](/assets/images/konnect/gateway-manager/plugins/konnect-custom-plugins.png){:.image-border}
