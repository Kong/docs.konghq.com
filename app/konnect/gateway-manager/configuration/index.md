...
* [{{site.konnect_short_name}} API](/konnect/api/control-plane-configuration/latest/)
* [decK](/konnect/gateway-manager/declarative-config/)

You can view and copy autogenerated YAML and JSON configuration for individual entities in {{site.konnect_short_name}}’s UI. 
...
check out the [service object API reference](/konnect/api/control-plane-configuration/latest/#/Services/list-service)
...
See the [route object API reference](/konnect/api/control-plane-configuration/latest/#/Routes/list-route)
for all configuration options.
...
See the [consumer object API reference](/konnect/api/control-plane-configuration/latest/#/Consumers/list-consumer)
for all configuration options.
...
check out the [plugin object API reference](/konnect/api/control-plane-configuration/latest/#/Plugins/list-plugin),
...
See the [upstream object API reference](/konnect/api/control-plane-configuration/latest/#/Upstreams/list-upstream)
for all configuration options.
...
See the [certificate object API reference](/konnect/api/control-plane-configuration/latest/#/Certificates/list-certificate)
for all configuration options.
...
See the [SNI object API reference](/konnect/api/control-plane-configuration/latest/#/SNIs/list-sni-with-certificate)
for all configuration options.
