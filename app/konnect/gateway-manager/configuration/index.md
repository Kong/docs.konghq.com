...
* [{{site.konnect_short_name}} API](/gateway/api/admin-ee/latest/#/Services)
* [decK](/konnect/gateway-manager/declarative-config/)

You can view and copy autogenerated YAML and JSON configuration for individual entities in {{site.konnect_short_name}}’s UI which. This allows you to learn the configuration structure, create configuration files, and switch seamlessly between configuration interfaces.
## Gateway services
