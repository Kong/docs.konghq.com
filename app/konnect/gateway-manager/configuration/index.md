...
You can view autogenerated YAML and JSON configuration in {{site.konnect_short_name}}’s UI which can be copied. This allows you to learn or create configuration files and switch seamlessly between configuration interfaces.
