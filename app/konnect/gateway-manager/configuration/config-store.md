...
> **Important:** The Konnect Config Store stores secrets at the Control Plane (CP) level, and secret references are resolved before sending the configuration to the Data Planes (DPs).
