...
**Gateway Manager** 
: Navigation around nested entities has been improved. For any plugin that the service, route, or consumer is configured for, it is now directly hyperlinked in the configuration.
